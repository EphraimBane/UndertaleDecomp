...
if (con == 2 && instance_exists(OBJ_WRITER) == false)
{
    ...
    draw_text((camera_0_x + 50), (camera_0_y + 15), string_hash_to_newline(scr_gettext("labtv_cancel")))
    draw_text((camera_0_x + 160), (camera_0_y + 15), string_hash_to_newline(scr_gettext("labtv_tape1")))
    draw_text((camera_0_x + 50), (camera_0_y + 35), string_hash_to_newline(scr_gettext("labtv_tape2")))
    draw_text((camera_0_x + 160), (camera_0_y + 35), string_hash_to_newline(scr_gettext("labtv_tape3")))
    draw_text((camera_0_x + 50), (camera_0_y + 55), string_hash_to_newline(scr_gettext("labtv_tape4")))
    draw_text((camera_0_x + 160), (camera_0_y + 55), string_hash_to_newline(scr_gettext("labtv_tape5")))
    draw_sprite(spr_heartsmall, 0, ((camera_0_x + 30) + (heartx * 110)), ((camera_0_y + 20) + (20 * hearty)))
    if (buffer < 0)
    {
