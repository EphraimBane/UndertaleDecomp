...
if (con == 2 && instance_exists(OBJ_WRITER) == false)
{
    ...
    draw_text((camera_get_view_x(view_camera[0]) + 50), (camera_get_view_y(view_camera[0]) + 15), string_hash_to_newline(scr_gettext("labtv_cancel")))
    draw_text((camera_get_view_x(view_camera[0]) + 160), (camera_get_view_y(view_camera[0]) + 15), string_hash_to_newline(scr_gettext("labtv_tape1")))
    draw_text((camera_get_view_x(view_camera[0]) + 50), (camera_get_view_y(view_camera[0]) + 35), string_hash_to_newline(scr_gettext("labtv_tape2")))
    draw_text((camera_get_view_x(view_camera[0]) + 160), (camera_get_view_y(view_camera[0]) + 35), string_hash_to_newline(scr_gettext("labtv_tape3")))
    draw_text((camera_get_view_x(view_camera[0]) + 50), (camera_get_view_y(view_camera[0]) + 55), string_hash_to_newline(scr_gettext("labtv_tape4")))
    draw_text((camera_get_view_x(view_camera[0]) + 160), (camera_get_view_y(view_camera[0]) + 55), string_hash_to_newline(scr_gettext("labtv_tape5")))
