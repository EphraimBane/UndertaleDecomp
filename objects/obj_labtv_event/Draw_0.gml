...
if (con == 2 && instance_exists(OBJ_WRITER) == false)
{
    ...
    draw_text((view_xview(0) + 50), (view_yview(0) + 15), string_hash_to_newline(scr_gettext("labtv_cancel")))
    draw_text((view_xview(0) + 160), (view_yview(0) + 15), string_hash_to_newline(scr_gettext("labtv_tape1")))
    draw_text((view_xview(0) + 50), (view_yview(0) + 35), string_hash_to_newline(scr_gettext("labtv_tape2")))
    draw_text((view_xview(0) + 160), (view_yview(0) + 35), string_hash_to_newline(scr_gettext("labtv_tape3")))
    draw_text((view_xview(0) + 50), (view_yview(0) + 55), string_hash_to_newline(scr_gettext("labtv_tape4")))
    draw_text((view_xview(0) + 160), (view_yview(0) + 55), string_hash_to_newline(scr_gettext("labtv_tape5")))
