...
if (con == 2 && instance_exists(OBJ_WRITER) == 0)
{
    ...
    draw_text((__view_get(VIEW_PROP_CAM_X, 0) + 50), (__view_get(VIEW_PROP_CAM_Y, 0) + 15), string_hash_to_newline(scr_gettext("labtv_cancel")))
    draw_text((__view_get(VIEW_PROP_CAM_X, 0) + 160), (__view_get(VIEW_PROP_CAM_Y, 0) + 15), string_hash_to_newline(scr_gettext("labtv_tape1")))
    draw_text((__view_get(VIEW_PROP_CAM_X, 0) + 50), (__view_get(VIEW_PROP_CAM_Y, 0) + 35), string_hash_to_newline(scr_gettext("labtv_tape2")))
    draw_text((__view_get(VIEW_PROP_CAM_X, 0) + 160), (__view_get(VIEW_PROP_CAM_Y, 0) + 35), string_hash_to_newline(scr_gettext("labtv_tape3")))
    draw_text((__view_get(VIEW_PROP_CAM_X, 0) + 50), (__view_get(VIEW_PROP_CAM_Y, 0) + 55), string_hash_to_newline(scr_gettext("labtv_tape4")))
    draw_text((__view_get(VIEW_PROP_CAM_X, 0) + 160), (__view_get(VIEW_PROP_CAM_Y, 0) + 55), string_hash_to_newline(scr_gettext("labtv_tape5")))
