...
if (myinteract == 1)
{
    if (con == 0)
    {
        ...
        yy = (camera_get_view_y(view_camera[0]) - 10)
        nowxx = camera_get_view_x(view_camera[0])
        nowyy = (camera_get_view_y(view_camera[0]) - 10)
    }
}
if (drawthis == 1)
{
...
if (con == 18)
{
    ...
    mywriter = instance_create((camera_get_view_x(view_camera[0]) + 30), (camera_get_view_y(view_camera[0]) + 100), obj_flowey_writer)
    con = 19
}
if (con == 19)
{
