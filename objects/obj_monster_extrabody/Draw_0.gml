if (active == true)
{
    ...
    if (type == 5)
    {
        siner += 1
        gosp = spr_migosp
        if (y < (__view_get(VIEW_PROP_CAM_Y, 0) + 240))
    ...
    if (type == 19)
    {
        if (y < (__view_get(VIEW_PROP_CAM_Y, 0) + 260))
        {
            if (msx.stage == 0)
                msx.stage = 1
        }
    ...
    if (type == 21)
    {
        if (y < (__view_get(VIEW_PROP_CAM_Y, 0) + 240) && bd == 0)
        {
            bd = 1
            with (bara1)
                event_user(2)
    ...
    if (type == 27)
    {
        if (y < (__view_get(VIEW_PROP_CAM_Y, 0) + 300))
        {
            siner2 += 1
            if (siner2 > 25)
                knight.asleep = 1
    ...
    if (type == 31)
    {
        if (y < (__view_get(VIEW_PROP_CAM_Y, 0) + 200))
        {
            if (aa.mega == 0)
            {
                aa.mega = 1
