...
if ((FL_PlayRainSound == 1 && room == room_water_prewaterfall) || room == room_water_waterfall3 || room == room_water_statue || room == room_water_preundyne)
{
...
if ((FL_PlayRainSound == 1 && room == room_water_waterfall) || room == room_water_waterfall2 || room == room_water_waterfall4)
{
