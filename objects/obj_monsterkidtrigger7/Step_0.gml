if (con == 1)
{
    mkid = instance_create((__view_get(0, obj_backgrounder_parent) - 40), obj_mainchara.y, obj_mkid_actor)
    mkid.image_speed = 0
...
{
    undyne = instance_create((__view_get(0, obj_backgrounder_parent) - 40), 82, obj_undynea_actor)
...
if (con == 34)
{
    ...
    con = 35
    global.flag[17] = 1
    doorb = instance_create((__view_get(0, obj_backgrounder_parent) - 20), (obj_mainchara.y + 10), obj_doorB)
    doora = instance_create(((__view_get(0, 0) + __view_get(2, obj_backgrounder_parent)) + 20), (obj_mainchara.y + 10), obj_doorA)
    undynetimer = 0
    finaltimer = 0
    mkidtalk = 0
    charge = 0
