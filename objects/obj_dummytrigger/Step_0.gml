...
{
    if (view_xview(0) < 130)
        __view_set(VIEW_PROP_CAM_X, 0, (view_xview(0) + (xdiff / 10)))
    if (view_xview(0) > 130)
        __view_set(VIEW_PROP_CAM_X, 0, 130)
    if (view_yview(0) < 192)
        __view_set(VIEW_PROP_CAM_Y, 0, (view_yview(0) + (ydiff / 10)))
    if (view_yview(0) > 192)
        __view_set(VIEW_PROP_CAM_Y, 0, 192)
    if (view_hview(0) > 120)
        __view_set(VIEW_PROP_CAM_HEIGHT, 0, (view_hview(0) - 12))
    if (view_hview(0) < 120)
        __view_set(VIEW_PROP_CAM_HEIGHT, 0, 120)
    if (view_wview(0) > 160)
        __view_set(VIEW_PROP_CAM_WIDTH, 0, (view_wview(0) - 16))
    if (view_wview(0) < 160)
...
if (con == 6.4)
{
    if (view_xview(view_current) > 0)
        __view_set(VIEW_PROP_CAM_X, view_current, (view_xview(view_current) - (xdiff / 10)))
    if (view_xview(0) < 0)
        __view_set(VIEW_PROP_CAM_X, 0, 0)
    if (view_yview(view_current) > rememberyview)
        __view_set(VIEW_PROP_CAM_Y, view_current, (view_yview(view_current) - (ydiff / 10)))
    if (view_yview(0) < rememberyview)
        __view_set(VIEW_PROP_CAM_Y, 0, rememberyview)
    if (view_hview(view_current) < 240)
        __view_set(VIEW_PROP_CAM_HEIGHT, view_current, (view_hview(view_current) + 12))
    if (view_hview(0) > 240)
        __view_set(VIEW_PROP_CAM_HEIGHT, 0, 240)
    if (view_wview(view_current) < 320)
        __view_set(VIEW_PROP_CAM_WIDTH, view_current, (view_wview(view_current) + 16))
    if (view_wview(0) > 320)
...
if (con == 8)
{
    __view_set(VIEW_PROP_CAM_Y, 0, (view_yview(0) - 6))
